...
____
### 효력일: 0000년 00월 00일
### 최종업데이트: 2023년 11월 12일 
___
## 제1장 총칙

### 제1조 (목적)

본 약관은 `레무링 오라리오` (이하 "회사")가 운영하는 https://remuring.xyz 에 위치한 웹사이트(이하 "웹사이트")를 이용하거나 접속하는 모든 행위는 "서비스"에 해당되며 이 서비스 이용에 대한 회사와 서비스 유저의 권리, 의무, 책임 등 필요한 사항을 규정함을 목적으로 합니다.
  또한 `레무링 오라리오` 계열사 또는 산하 회사를 이용, 접속하는 모든 행위 또한 "서비스"로 규정합니다.

### 제2조 (용어의 정의)

1. 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
   - "회사", "당사"는 서비스를 제공하는 `레무링 오라리오`를 의미합니다.
   - "플랫폼"은 당사가 서비스하는 모든 웹사이트를 의미합니다.
   - "커뮤니티"는 당사의 [공식 디스코드](https://remuring.xyz/official-community) (임시) 를 의미합니다.
   - "공식 SNS"는 당사의 공식 [트위터](), [페이스북](), [인스타그램]()등 을 의미합니다
...
2. 회사가 약관을 개정할 경우에는 적용일자 및 개정내용, 개정사유 등을 명시하도록 하며, 최소한 그 적용일 7일 이전에 유저에게 공지합니다. 다만, 변경된 내용이 유저에게 불리하거나 중대한 사항의 변경인 경우에는 그 적용일 14일 이전까지 본문과 같은 방법으로 공지하고 19조 1항의 방법으로 유저에게 통지합니다.
3. 회사의 약관이 개정될 때 2항에 따라 약관 변경을 공지 또는 통보하며, 유저의 거부 의사를 확인합니다. 거부 의사를 당사에 알리지 않는 경우 새로운 약관에 동의한 것으로 간주합니다.

### 제4조 (이용 계약의 체결 및 적용)

1. 이메일 또는 소셜미디어 가입을 통해 당사의 플랫폼에 로그인하는 경우 계약이 채결된 것으로 간주합니다.
...
2. 회사는 관련 법령에 의해 관련 국가기관 및 수사기관 등의 요청이 있는 경우를 제외하고는 유저의 개인정보를 본인의 동의 없이 타인에게 제공하지 않습니다.
3. 회사는 유저의 귀책사유로 개인정보가 유출되어 발생한 피해에 대하여 책임을 지지 않습니다.
...
2. 회사는 제1항의 이의신청서를 접수된 경우 정상 접수되었음을 회신하고, 접수된 날부터 30일 이내에 불복 이유에 대하여 제1항에서 접수된 방법과 동일한 방법으로 답변하되, 동일한 방법으로 답변이 어렵다면 전자우편 또는 이에 준하는 방법으로 답변합니다.
...
본 약관은 **한국어**를 정본으로 함을 원칙으로 합니다. 본 약관 또는 당사의 서비스와 관련된 이용자와 당사와의 관계에는 대한민국 법령이 적용됩니다. 또한 당사의 서비스와 관련하여 이용자와 당사 사이에 분쟁이 발생할 경우, 그 분쟁의 처리는 대한민국 **민사소송법**에 정의된 절차를 따릅니다.

___
# 본 약관은 아직 서비스가 출시하지 않았음으로 유효하지 않습니다.
